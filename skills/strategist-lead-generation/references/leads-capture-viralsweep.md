---
name: leads-capture-viralsweep
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/leads_capture/viralsweep
...
keywords:
  ...
  - endpoint
triggers:
  - how to connect ViralSweep to Braze
  - set up sweepstakes integration
  - send promotion entries to Braze
  - configure ViralSweep API credentials
---
