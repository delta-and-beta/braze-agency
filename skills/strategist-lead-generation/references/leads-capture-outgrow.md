---
name: leads-capture-outgrow
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/leads_capture/outgrow
...
keywords:
  ...
  - calculator
triggers:
  - how to integrate outgrow with braze
  - set up outgrow data collection
  - map quiz responses to braze attributes
  - configure braze api for outgrow
  - collect user data from interactive content
---
