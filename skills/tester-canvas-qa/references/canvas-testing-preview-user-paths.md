---
name: canvas-testing-preview-user-paths
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/testing_canvases/preview_user_paths
...
keywords:
  ...
  - trigger
triggers:
  - how to preview canvas
  - preview user path
  - test canvas before sending
  - preview message timing
  - preview canvas steps
---
