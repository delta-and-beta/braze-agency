---
name: canvas-testing-sending-test-canvases
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/testing_canvases/sending_test_canvases
...
keywords:
  ...
  - liquid
triggers:
  - test canvas before launching
  - create test users
  - duplicate canvas for testing
  - preview user paths
  - verify canvas messages
---
