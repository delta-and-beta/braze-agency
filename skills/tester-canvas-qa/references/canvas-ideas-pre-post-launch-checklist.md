---
name: canvas-ideas-pre-post-launch-checklist
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/ideas_and_strategies/pre_post_launch_checklist
...
keywords:
  ...
  - checklist
triggers:
  - how to set up canvas timezones
  - canvas pre-launch checklist
  - avoiding race conditions in canvas
  - using regex for audience filters
  - reviewing canvas target audience
---
