---
name: partners-referrals-friendbuy
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_personalization/referrals/friendbuy
...
keywords:
  ...
  - email
triggers:
  - how to integrate Friendbuy with Braze
  - set up Friendbuy integration
  - configure referral program
  - connect Friendbuy API
  - enable Friendbuy loyalty program
---
