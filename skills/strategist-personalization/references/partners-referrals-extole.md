---
name: partners-referrals-extole
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_personalization/referrals/extole
...
keywords:
  ...
  - segmentation
triggers:
  - connect Extole to Braze
  - send referral events to Braze
  - configure Extole integration
  - set up referral programs
  - sync customer data from Extole
---
