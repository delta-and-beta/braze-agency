---
name: in-app-messages-prep-guide
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/message_building_by_channel/in-app_messages/best_practices/prep_guide
...
keywords:
  ...
  - session
triggers:
  - preparing in-app messages
  - building message campaigns
  - targeting users for delivery
  - scheduling message display
