---
name: ab-testing-optimizely
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/ab_testing/optimizely
...
keywords:
  ...
  - events
triggers:
  - How to set up Optimizely integration with Braze
  - Syncing Braze segments to Optimizely
  - Configuring Braze Currents export
  - Mapping Braze data fields to Optimizely
  - Importing customer profiles from Braze
---
