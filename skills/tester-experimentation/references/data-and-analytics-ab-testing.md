---
name: data-and-analytics-ab-testing
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/ab_testing/vwo
...
keywords:
  ...
  - custom-events
triggers:
  - how to integrate VWO with Braze
  - create segment from VWO experiment data
  - set up VWO integration
  - configure A/B testing in Braze
