---
name: shopify-discount-codes
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/ecommerce/shopify/discount_codes
...
triggers:
  ...
  - generate discount codes in shopify
  - create promotion codes in braze
  - export codes from shopify
  - use discount codes in campaigns
---
