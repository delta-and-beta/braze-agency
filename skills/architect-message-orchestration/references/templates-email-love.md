---
name: templates-email-love
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_orchestration/templates/email_love
...
keywords:
  ...
  - components
triggers:
  - how to export email to Braze
  - design responsive email templates
  - upload email template
  - configure Email Love
  - set up Braze API key
---
