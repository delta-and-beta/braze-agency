---
name: templates-iam-studio
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_orchestration/templates/iam_studio
...
keywords:
  ...
  - fonts
triggers:
  - customize in-app message templates
  - create personalized messages with liquid
  - set up deeplinks for messages
  - enable tracking and logging
  - choose and personalize in-app templates
---
