---
name: templates-denada
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_orchestration/templates/denada
...
keywords:
  ...
  - creative
triggers:
  - export email templates to Braze
  - create on-brand email content
  - upload images to media library
  - configure Denada integration
  - push templates to Braze
---
