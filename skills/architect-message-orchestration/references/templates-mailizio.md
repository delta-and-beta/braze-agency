---
name: templates-mailizio
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_orchestration/templates/Mailizio
...
keywords:
  ...
  - branding
triggers:
  - How to export email templates to Braze
  - Create reusable email content modules
  - Design emails with Liquid variables
  - Generate in-app messages from email
---
