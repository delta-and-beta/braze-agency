---
name: templates-stripo
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_orchestration/templates/stripo
...
keywords:
  ...
  - builder
triggers:
  - export stripo email to braze
  - upload email template
  - create responsive email
  - configure stripo api key
