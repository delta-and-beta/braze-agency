---
name: message-orchestration-cms-dam-contentful
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_orchestration/cms_dam/contentful
...
keywords:
  ...
  - configuration
triggers:
  - integrate Contentful with Braze
  - configure Connected Content for Contentful
  - fetch content from Contentful
  - set up Contentful API credentials
  - connect Contentful to campaigns
---
