---
name: templates-alpaco
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_orchestration/templates/alpaco
...
keywords:
  ...
  - messaging
triggers:
  - export templates to Braze
  - create content blocks
  - set up Alpaco integration
