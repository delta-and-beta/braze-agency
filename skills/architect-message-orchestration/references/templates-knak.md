...
name: templates-knak
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_orchestration/templates/knak
...
keywords:
  ...
  - export
triggers:
  - how to set up knak integration with braze
  - export email templates from knak to braze
  - sync knak templates to braze
  - create responsive emails with knak
---
