---
name: message-personalization-location
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_personalization/location/radar
...
keywords:
  ...
  - integration
triggers:
  - how to set up Radar geofencing with Braze
  - enable location-based campaigns
  - personalize messages using location data
