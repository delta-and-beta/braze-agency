---
name: location-loplat
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_personalization/location/loplat
...
keywords:
  ...
  - segmentation
triggers:
  - set up location-based campaigns
  - trigger campaigns when users visit store
  - send location-triggered push messages
  - integrate loplat SDK with Braze
  - measure store footfall analytics
---
