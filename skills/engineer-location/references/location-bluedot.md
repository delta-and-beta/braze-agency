---
name: location-bluedot
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_personalization/location/bluedot
...
keywords:
  ...
  - exit
triggers:
  - set up geofencing campaigns
  - trigger messages on location entry
  - integrate Bluedot SDK
  - create location-based campaigns
  - send push notifications on location exit
---
