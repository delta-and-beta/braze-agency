---
name: campaigns-ideas-new-features
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/campaigns/ideas_and_strategies/new_features
...
keywords:
  ...
  - awareness
triggers:
  - how to filter users by app version
  - how to target users with older app versions
  - how to segment users by app version number
  - promote new features to app users
  - encourage users to update their app
---
