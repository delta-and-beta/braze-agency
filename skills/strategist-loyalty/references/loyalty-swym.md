---
name: loyalty-swym
source_url: 'https://braze-inc.github.io/braze-docs/_partners/ecommerce/loyalty/swym'
...
keywords:
  ...
  - authentication
triggers:
  - how to connect Swym to Braze
  - send custom events to Braze
  - trigger automated messages from wishlist
