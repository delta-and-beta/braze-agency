---
name: retargeting-jampp
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_orchestration/retargeting/jampp
...
keywords:
  ...
  - ios
triggers:
  - how to set up Jampp retargeting
  - sync events to Jampp
  - configure Jampp webhook template
  - retarget mobile customers with Braze
  - send personalized ads via Jampp
---
