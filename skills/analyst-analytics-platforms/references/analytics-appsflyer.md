...
keywords:
  ...
  - postback
triggers:
  - how to import user cohorts from AppsFlyer
  - set up AppsFlyer audiences in Braze
  - configure AppsFlyer SDK for Braze
  - create AppsFlyer to Braze connection
  - import AppsFlyer audiences
---
