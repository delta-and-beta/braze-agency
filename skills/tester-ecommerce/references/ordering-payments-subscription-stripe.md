---
name: ordering-payments-subscription-stripe
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/ecommerce/ordering_payments_subscription/stripe
...
keywords:
  ...
  - revenue
triggers:
  - how to integrate Stripe with Braze
  - how to set up Stripe webhooks
  - how to trigger messages based on payment events
  - how to personalize messaging with Stripe data
