---
name: shopify-shopify-standard-integration
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/ecommerce/shopify/shopify_standard_integration_third_party_tagging
...
keywords:
  ...
  - deployment
triggers:
  - integrate Shopify with third-party tools
  - set up Braze and Google Tag Manager
  - configure SDK initialization timing
  - manage Shopify API keys
  - troubleshoot third-party tool conflicts
---
