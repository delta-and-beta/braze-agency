---
name: ordering-payments-subscription-revenuecat
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/ecommerce/ordering_payments_subscription/revenuecat
...
triggers:
  ...
  - sync subscription events to Braze
  - trigger campaigns on billing issues
  - set up user identity matching
