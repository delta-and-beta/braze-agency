---
name: canvas-get-started-braze-templates-email-signup
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/get_started/braze_templates/email_signup
...
keywords:
  ...
  - journey
triggers:
  - set up email sign-up canvas
  - create double opt-in template
  - assign conversion events
  - configure in-app messages
  - build email capture journey
---
