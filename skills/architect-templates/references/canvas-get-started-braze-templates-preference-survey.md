---
name: canvas-get-started-braze-templates-preference-survey
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/get_started/braze_templates/preference_survey
...
keywords:
  ...
  - workflow
triggers:
  - create onboarding canvas
  - set up preferences survey
  - target new users with onboarding
