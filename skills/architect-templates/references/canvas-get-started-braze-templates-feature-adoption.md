---
name: canvas-get-started-braze-templates-feature-adoption
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/get_started/braze_templates/feature_adoption
...
triggers:
  ...
  - encourage users to adopt new features
  - collect user feedback on features
  - set up feature adoption canvas
