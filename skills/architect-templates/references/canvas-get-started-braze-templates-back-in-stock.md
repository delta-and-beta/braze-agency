---
name: canvas-get-started-braze-templates-back-in-stock
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/get_started/braze_templates/back_in_stock
...
keywords:
  ...
  - reminders
triggers:
  - notify users when back in stock
  - create back in stock campaign
  - set up product availability alerts
  - inventory notification messaging
---
