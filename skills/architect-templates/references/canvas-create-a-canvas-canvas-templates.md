---
name: canvas-create-a-canvas-canvas-templates
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/create_a_canvas/canvas_templates
...
triggers:
  ...
  - use Canvas template
  - build Canvas journey
  - customize Canvas template
---
