---
name: attribution-kochava
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_orchestration/attribution/kochava
...
keywords:
  ...
  - device-id
triggers:
  - how to integrate kochava with braze
  - map user ids for attribution
  - set up kochava attribution tracking
  - configure device id linking between platforms
---
