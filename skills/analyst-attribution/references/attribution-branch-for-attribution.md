---
name: attribution-branch-for-attribution
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_orchestration/attribution/branch_for_attribution
...
keywords:
  ...
  - mobile
triggers:
  - how to set up branch attribution
  - integrate branch for attribution
  - map device ids to branch
  - configure branch deep linking
  - implement branch integration
---
