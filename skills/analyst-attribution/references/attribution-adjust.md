...
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_orchestration/attribution/adjust
...
triggers:
  ...
  - map device IDs for attribution
  - track mobile app installations
  - configure iOS attribution mapping
  - integrate Adjust and Braze
---
