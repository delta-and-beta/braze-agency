---
name: message-orchestration-attribution
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_orchestration/attribution/singular
...
keywords:
  ...
  - cost
triggers:
  - how to integrate Singular attribution with Braze
  - set up paid install attribution tracking
  - map user IDs for attribution
  - configure attribution data import
  - implement Singular SDK
---
