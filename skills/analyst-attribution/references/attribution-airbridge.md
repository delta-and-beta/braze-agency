---
name: attribution-airbridge
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/message_orchestration/attribution/airbridge
...
keywords:
  ...
  - tracking
triggers:
  - how to integrate Airbridge with Braze
  - map device ID to Airbridge
  - set up mobile attribution
  - configure Airbridge SDK
  - enable non-organic install tracking
---
