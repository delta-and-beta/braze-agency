...
keywords:
  ...
  - install
triggers:
  - integrate Singular attribution
  - map Braze IDs to Singular
  - import paid install data
  - set up Singular tracking
  - segment by attribution
---
