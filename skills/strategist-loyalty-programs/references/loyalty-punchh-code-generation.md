---
name: loyalty-punchh-code-generation
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/loyalty/punchh/code_generation
...
triggers:
  ...
  - integrate punchh with braze
  - create jwt token for coupons
