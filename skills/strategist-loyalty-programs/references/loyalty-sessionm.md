---
name: loyalty-sessionm
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/loyalty/sessionm
...
keywords:
  ...
  - customer
triggers:
  - how to integrate SessionM with Braze
  - set up SessionM authentication
  - create loyalty campaigns
  - configure SessionM API
  - manage customer loyalty data
---
