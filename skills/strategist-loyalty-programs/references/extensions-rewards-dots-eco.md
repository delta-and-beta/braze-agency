---
name: extensions-rewards-dots-eco
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/additional_channels_and_extensions/extensions/rewards/dots_eco
...
keywords:
  ...
  - Braze
triggers:
  - How to reward users with impact certificates
  - Integrate DOTS.ECO with Braze Canvas
  - Trigger certificate creation on user events
  - Store certificate metadata on user profiles
  - Show certificates in messaging channels
---
