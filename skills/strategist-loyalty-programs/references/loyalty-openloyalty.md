---
name: loyalty-openloyalty
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/loyalty/openloyalty
...
keywords:
  ...
  - rewards
triggers:
  - how to sync loyalty data
  - track loyalty events
  - configure loyalty integration
