---
name: canvas-ideas-ecommerce-use-cases
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/ideas_and_strategies/ecommerce_use_cases
...
keywords:
  ...
  - campaigns
triggers:
  - how to use ecommerce canvas templates
  - personalize messages with liquid
  - create customer segments for campaigns
  - use ecommerce recommended events
  - apply braze canvas templates
---
