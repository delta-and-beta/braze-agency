---
name: canvas-ideas-matching-entry-and-exit-criteria
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/ideas_and_strategies/matching_entry_and_exit_criteria
...
keywords:
  ...
  - properties
triggers:
  - match exit criteria to entry events
  - compare event properties in canvas
  - set up abandoned checkout flows
  - branch based on matching actions
  - personalize using context variables
---
