...
name: sms-create
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/message_building_by_channel/sms_mms_rcs/sms/create
...
triggers:
  ...
  - send SMS message
  - set up SMS variant
  - configure SMS subscription group
  - create SMS user journey
---
