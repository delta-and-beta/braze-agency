---
name: canvas-get-started-braze-templates-abandoned-cart
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/get_started/braze_templates/abandoned_cart
...
keywords:
  ...
  - integration
triggers:
  - set up abandoned cart campaign
  - create user journey for cart abandonment
  - send cart reminder messages
  - track purchase conversions
  - sync audiences with partners
---
