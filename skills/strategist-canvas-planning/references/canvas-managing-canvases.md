---
name: canvas-managing-canvases
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/managing_canvases/cloning_canvases
...
keywords:
  ...
  - duplicate
triggers:
  - clone canvas to canvas flow
  - duplicate existing canvas
  - migrate canvas to flow
  - manage canvas versions
  - convert to canvas flow
---
