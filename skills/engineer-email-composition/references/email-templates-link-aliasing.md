---
name: email-templates-link-aliasing
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/message_building_by_channel/email/templates/link_aliasing
...
triggers:
  ...
  - Retarget users by link clicks
  - Analyze link performance metrics
  - Set up link-triggered actions
---
