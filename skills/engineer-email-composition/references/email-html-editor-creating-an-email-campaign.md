---
name: email-html-editor-creating-an-email-campaign
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/message_building_by_channel/email/html_editor/creating_an_email_campaign
...
triggers:
  ...
  - set up email variants
  - create A/B test email
  - build email canvas
---
