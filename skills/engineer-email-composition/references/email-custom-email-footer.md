---
name: email-custom-email-footer
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/message_building_by_channel/email/custom_email_footer
...
keywords:
  ...
  - preferences
triggers:
  - how to create custom email footer
  - add unsubscribe link to email
  - configure email footer settings
  - set up email preferences
  - customize email template footer
---
