---
name: email-templates-html-email-template
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/message_building_by_channel/email/templates/html_email_template
...
keywords:
  ...
  - braze
triggers:
  - upload HTML email template
  - create email template
  - save email template
  - use template in campaign
  - troubleshoot template upload
---
