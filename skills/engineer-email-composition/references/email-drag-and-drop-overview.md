---
name: email-drag-and-drop-overview
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/message_building_by_channel/email/drag_and_drop/overview
...
keywords:
  ...
  - layout
triggers:
  - create email with drag-and-drop
  - build custom email without HTML
  - design email layout
  - add content blocks to message
  - structure email for campaign
---
