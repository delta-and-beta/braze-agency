---
name: email-transactional-message-api-campaign
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/message_building_by_channel/email/transactional_message_api_campaign
...
triggers:
  ...
  - creating order confirmation campaigns
  - setting up business-critical notifications
  - configuring transactional email API
  - implementing password reset emails
---
