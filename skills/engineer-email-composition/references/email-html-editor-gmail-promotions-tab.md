---
name: email-html-editor-gmail-promotions-tab
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/message_building_by_channel/email/html_editor/gmail_promotions_tab
...
keywords:
  ...
  - braze
triggers:
  - set up Gmail Promotions tab
  - build a promotion card in Braze
  - create a discount offer card
  - configure Gmail rich cards
  - add product carousel to email
---
