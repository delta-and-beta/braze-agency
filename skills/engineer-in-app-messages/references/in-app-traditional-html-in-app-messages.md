---
name: in-app-traditional-html-in-app-messages
source_url: >-
...
triggers:
  ...
  - track message button clicks
  - add JavaScript to messages
  - create custom animations
  - use the JavaScript bridge
---
...
You can track performance within your custom code in-app message using the [`brazeBridge.logClick(button_id)`]({{site.baseurl}}/user_guide/message_building_by_channel/in-app_messages/creative_details/) JavaScript method. For the full reference, see [JavaScript Bridge methods](#bridge) above.
