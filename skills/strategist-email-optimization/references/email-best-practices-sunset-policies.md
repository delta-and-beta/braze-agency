---
name: email-best-practices-sunset-policies
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/message_building_by_channel/email/best_practices/sunset_policies
...
keywords:
  ...
  - filtering
triggers:
  - create sunset policies
  - set up email segmentation
  - stop sending to unengaged users
  - prevent emails from spam folder
  - implement disengagement filters
---
