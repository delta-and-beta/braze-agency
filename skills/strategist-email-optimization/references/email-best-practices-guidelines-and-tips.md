---
name: email-best-practices-guidelines-and-tips
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/message_building_by_channel/email/best_practices/guidelines_and_tips
...
keywords:
  ...
  - templates
triggers:
  - how to format email campaigns
  - email validation requirements
  - setting up from and reply-to addresses
  - optimizing images for email
  - mobile email template design
---
