---
name: sms-mms-rcs-retargeting
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/message_building_by_channel/sms_mms_rcs/retargeting
...
keywords:
  ...
  - audiences
triggers:
  - retarget users based on SMS reception
  - trigger messages on SMS interaction
  - filter users by campaign interaction
  - set up SMS tracking links
