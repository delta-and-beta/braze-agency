---
name: analytics-tellius
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/business_intelligence/tellius
...
keywords:
  ...
  - queries
triggers:
  - connect tellius to snowflake
  - load datasets in tellius
  - create business view
  - enable tellius integration with braze
  - generate insights from braze data
---
