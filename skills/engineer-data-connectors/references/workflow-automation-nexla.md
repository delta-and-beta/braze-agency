---
name: workflow-automation-nexla
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/workflow_automation/nexla
...
keywords:
  ...
  - credentials
triggers:
  - how to set up Nexla integration
  - create data flows with Braze
  - transform Braze data
  - connect Braze as a source
  - configure Nexla credentials
---
