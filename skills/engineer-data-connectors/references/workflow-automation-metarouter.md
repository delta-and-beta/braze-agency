---
name: workflow-automation-metarouter
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/workflow_automation/metarouter
...
keywords:
  ...
  - sdk
triggers:
  - how to set up metarouter with braze
  - integrating braze event tracking
  - configuring event mapping
  - sending customer data to braze
  - setting up metarouter pipelines
---
