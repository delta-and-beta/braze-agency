---
name: workflow-automation-fivetran
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/workflow_automation/fivetran
...
keywords:
  ...
  - credentials
triggers:
  - how to set up fivetran with braze
  - connect braze to data warehouse
  - export braze data to cloud storage
