---
name: campaigns-building-triggered-delivery
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/campaigns/building_campaigns/delivery_types/triggered_delivery
...
keywords:
  ...
  - personalization
triggers:
  - set up triggered campaign
  - send event-based messages
  - create action-triggered delivery
  - configure campaign trigger events
  - send after user action
---
