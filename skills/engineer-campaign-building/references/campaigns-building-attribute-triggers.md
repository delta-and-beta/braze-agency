---
name: campaigns-building-attribute-triggers
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/campaigns/building_campaigns/delivery_types/triggered_delivery/attribute_triggers
...
keywords:
  ...
  - audience
triggers:
  - send message when subscription changes
  - trigger on custom attribute change
  - update subscription group status
  - configure action-based delivery
  - target users on attribute value update
---
