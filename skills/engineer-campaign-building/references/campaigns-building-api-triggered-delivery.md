---
name: campaigns-building-api-triggered-delivery
source_url: >-
...
keywords:
  ...
  - multivariate
triggers:
  - how to set up API-triggered campaign
  - configure API-triggered delivery
  - include templated content with API request
  - manage campaign re-eligibility
  - trigger campaigns from server
---
