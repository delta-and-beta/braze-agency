---
name: help-api-attribute-name-id-across-sources
source_url: >-
  https://braze-inc.github.io/braze-docs/_help/help_articles/api/attribute_name_id_across_sources
...
keywords:
  ...
  - endpoint
triggers:
  - map attributes across sources
  - find campaign ID in API
  - use liquid tags for campaigns
  - Canvas attributes reference
  - track events in Currents
---
