---
name: help-data-dispatch-id
source_url: 'https://braze-inc.github.io/braze-docs/_help/help_articles/data/dispatch_id'
...
keywords:
  ...
  - multichannel
triggers:
  - how to template dispatch ID in messages
  - dispatch ID behavior for campaigns
  - track dispatch with Canvas
  - dispatch ID in Currents email events
---
