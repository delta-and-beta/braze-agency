---
name: help-data-blocklisting-deletion
source_url: >-
  https://braze-inc.github.io/braze-docs/_help/help_articles/data/blocklisting_deletion
...
keywords:
  ...
  - data
triggers:
  - difference between blocklisting and deletion
  - should I blocklist or delete custom data
  - restore deleted custom attributes
  - remove custom events from profiles
  - manage workspace custom data
---
