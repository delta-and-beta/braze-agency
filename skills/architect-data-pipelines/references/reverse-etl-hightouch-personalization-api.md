---
name: reverse-etl-hightouch-personalization-api
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/reverse_etl/hightouch/hightouch_personalization_api
...
keywords:
  ...
  - real-time
triggers:
  - how to integrate Hightouch Personalization API with Braze
  - set up product recommendations using Hightouch
  - make API calls in Braze Connected Content
  - enrich campaigns with dynamic data at send time
---
