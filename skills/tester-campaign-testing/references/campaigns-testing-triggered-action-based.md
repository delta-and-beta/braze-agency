---
name: campaigns-testing-triggered-action-based
source_url: >-
...
triggers:
  ...
  - create test user segments
  - inspect campaign payloads
  - troubleshoot campaign triggering
  - view deliverability logs
---
