---
name: campaigns-testing-and-more
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/campaigns/testing_and_more/triggered_action_based
...
keywords:
  ...
  - message
triggers:
  - how to test campaigns before launching
  - set up test user segment for campaigns
  - test API-triggered campaigns
  - inspect campaign payloads and logs
  - troubleshoot campaign delivery
---
