---
name: partners-audience-sync-overview
source_url: 'https://braze-inc.github.io/braze-docs/_partners/canvas_audience_sync/overview'
...
keywords:
  ...
  - acquisition
triggers:
  - how to sync audiences to advertising platforms
  - setting up Audience Sync destinations
  - creating lookalike audiences
  - retargeting users with ads
  - configuring audience suppression
---
