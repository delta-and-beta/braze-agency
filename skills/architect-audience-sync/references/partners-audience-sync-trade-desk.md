---
name: partners-audience-sync-trade-desk
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/canvas_audience_sync/trade_desk_audience_sync
...
keywords:
  ...
  - segment
triggers:
  - sync audiences to The Trade Desk
  - retarget users on The Trade Desk
  - set up Trade Desk integration
  - exclude users from Trade Desk
  - send first-party data to The Trade Desk
---
