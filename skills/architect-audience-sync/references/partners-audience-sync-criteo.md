---
name: partners-audience-sync-criteo
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/canvas_audience_sync/criteo_audience_sync
...
keywords:
  ...
  - advertising
triggers:
  - set up audience sync to Criteo
  - connect Criteo to Braze
  - target users with Criteo ads
  - create suppression audiences
  - sync segments to Criteo
---
