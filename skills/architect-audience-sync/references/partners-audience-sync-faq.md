---
name: partners-audience-sync-faq
source_url: 'https://braze-inc.github.io/braze-docs/_partners/canvas_audience_sync/faq'
...
keywords:
  ...
  - data
triggers:
  - how long to populate audiences
  - reconnect audience sync integration
  - configure audience sync partner
  - troubleshoot audience sync errors
