...
keywords:
  ...
  - schedule
triggers:
  - import Kubit cohorts to Braze
  - configure Kubit integration
  - create Braze segments from Kubit
  - set up Kubit data import
  - schedule cohort imports
---
