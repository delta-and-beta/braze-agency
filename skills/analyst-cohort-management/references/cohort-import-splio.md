---
name: cohort-import-splio
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/cohort_import/splio
...
keywords:
  ...
  - data
triggers:
  - how to import Splio cohorts
  - create a Splio segment
  - export campaigns from Splio
  - set up Splio integration
  - target Splio audiences in campaigns
---
