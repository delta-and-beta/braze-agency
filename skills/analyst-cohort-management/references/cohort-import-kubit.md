---
name: cohort-import-kubit
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/cohort_import/kubit
...
keywords:
  ...
  - postback
triggers:
  - how to import cohorts to Braze
  - set up Kubit integration with Braze
  - create and schedule cohort imports
  - configure data import key
  - use Kubit cohorts in Braze segments
---
