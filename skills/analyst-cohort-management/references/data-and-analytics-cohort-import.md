---
name: data-and-analytics-cohort-import
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/reverse_etl/hightouch/hightouch_cohort_import
...
keywords:
  ...
  - campaign
triggers:
  - import Hightouch cohorts
  - sync audience to Braze
  - create segment from Hightouch
  - set up Hightouch integration
  - match users in cohorts
---
