---
name: cohort-import-appsflyer-audiences
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/cohort_import/appsflyer_audiences
...
keywords:
  ...
  - Mobile
triggers:
  - import AppsFlyer audiences to Braze
  - set up AppsFlyer data import
  - configure AppsFlyer SDK integration
  - create AppsFlyer Braze connection
  - import user cohorts from AppsFlyer
---
