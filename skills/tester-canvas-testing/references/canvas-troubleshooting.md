---
name: canvas-troubleshooting
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/troubleshooting
...
keywords:
  ...
  - Settings
triggers:
  - troubleshoot Canvas delivery
  - Canvas not sending messages
  - user didn't receive Canvas step
  - Canvas triggering issues
  - configure Canvas schedule
---
