---
name: data-warehouses-snowflake
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/data_warehouses/snowflake
...
keywords:
  ...
  - analytics
triggers:
  - how to integrate Snowflake with Braze
  - set up Snowflake data sharing
  - sync data from Snowflake
  - query Braze data in Snowflake
  - configure Cloud Data Ingestion
---
