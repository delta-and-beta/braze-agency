---
name: data-warehouses-snowflake-etl-pipeline-setup
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/data_warehouses/snowflake/etl_pipline_setup
...
keywords:
  ...
  - events
triggers:
  - how to set up email click pipeline
  - configure Snowflake ETL
  - sync Braze Currents to Snowflake
  - create Braze data warehouse
