---
name: analytics-workflow-peak
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/ecommerce/analytics_workflow/peak
...
keywords:
  ...
  - model
triggers:
  - import churn predictions to Braze
  - sync Peak customer attributes
  - configure Peak integration
  - target users with predictive attributes
  - set up Peak and Braze
---
