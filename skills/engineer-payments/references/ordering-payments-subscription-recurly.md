---
name: ordering-payments-subscription-recurly
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/ecommerce/ordering_payments_subscription/recurly
...
keywords:
  ...
  - renewal
triggers:
  - how to connect Recurly to Braze
  - send subscription data to Braze
  - trigger campaigns from subscription events
