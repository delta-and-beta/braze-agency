---
name: keywords-double-opt-in
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/message_building_by_channel/sms_mms_rcs/keywords/double_opt_in
...
triggers:
  ...
  - configure opt-in keywords
  - set up double opt-in workflow
