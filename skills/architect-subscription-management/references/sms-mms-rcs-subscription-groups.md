---
name: sms-mms-rcs-subscription-groups
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/message_building_by_channel/sms_mms_rcs/subscription_groups
...
keywords:
  ...
  - states
triggers:
  - set up SMS subscription groups
  - manage user subscription states
  - handle opt-in and opt-out
  - understand subscription groups for messaging
  - configure RCS subscriptions
---
