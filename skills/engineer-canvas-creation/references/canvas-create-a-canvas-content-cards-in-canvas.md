---
name: canvas-create-a-canvas-content-cards-in-canvas
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/create_a_canvas/canvas_by_channel/content-cards_in_canvas
...
keywords:
  ...
  - timing
triggers:
  - how to send content cards in canvas
  - setting content card expiration
  - managing card removal and lifecycle
  - content card delivery timing
  - configure canvas message steps
---
