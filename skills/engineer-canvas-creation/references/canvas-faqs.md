...
name: canvas-faqs
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/faqs
...
keywords:
  ...
  - exceptions
triggers:
  - how to add canvas steps
  - difference between component and step
  - disconnected canvas steps
  - canvas audience evaluation
  - editing canvas workflow
---
