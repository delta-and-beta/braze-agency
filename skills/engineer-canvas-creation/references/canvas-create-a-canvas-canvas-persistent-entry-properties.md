---
name: canvas-create-a-canvas-canvas-persistent-entry-properties
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/create_a_canvas/context_and_event_properties/canvas_persistent_entry_properties
...
keywords:
  ...
  - conditional
triggers:
  - use entry properties to personalize messages
  - reference canvas entry properties in liquid
  - handle null entry properties with conditionals
  - trigger canvas with api calls
  - filter with event property segmentation
---
