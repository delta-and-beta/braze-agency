---
name: canvas-create-a-canvas-exit-criteria
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/create_a_canvas/exit_criteria
...
keywords:
  ...
  - condition
triggers:
  - set up Canvas exit criteria
  - configure exception events for Canvas
  - exit users from Canvas
  - how to use Canvas exit criteria
  - target Canvas audiences with exit conditions
---
