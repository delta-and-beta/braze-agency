---
name: canvas-create-a-canvas-context-and-event-properties
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/create_a_canvas/context_and_event_properties
...
keywords:
  ...
  - trigger
triggers:
  - how to use context properties in canvas
  - difference between context and event properties
  - reference event properties in messages
  - access canvas entry properties
  - use properties in canvas workflows
---
