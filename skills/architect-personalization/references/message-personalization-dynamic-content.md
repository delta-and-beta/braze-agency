---
name: message-personalization-dynamic-content
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/personalization_and_dynamic_content/liquid/aborting_messages
...
keywords:
  ...
  - logging
triggers:
  - how to abort messages
  - prevent message delivery
  - personalize messages by language
  - conditionally send messages
  - skip users in campaigns
---
