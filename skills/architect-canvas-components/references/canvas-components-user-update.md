---
name: canvas-components-user-update
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/canvas_components/user_update
...
triggers:
  ...
  - remove custom attributes from profile
  - track user progress
