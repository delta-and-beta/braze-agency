---
name: canvas-components-action-paths
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/canvas_components/action_paths
...
keywords:
  ...
  - actions
triggers:
  - how to create action paths
  - route users based on actions
  - set evaluation windows
  - enable ranking for user routing
  - customize user journeys by engagement
---
