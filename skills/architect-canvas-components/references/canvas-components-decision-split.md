---
name: canvas-components-decision-split
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/canvas_components/decision_split
...
keywords:
  ...
  - segmentation
triggers:
  - how to create a decision split
  - split users by conditions
  - personalize user journeys
  - segment users in canvas
