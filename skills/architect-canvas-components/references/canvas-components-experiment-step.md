---
name: canvas-components-experiment-step
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/canvas_components/experiment_step
...
keywords:
  ...
  - audiences
triggers:
  - How to create experiment paths
  - Test different canvas paths
  - Compare messaging cadence
  - A/B test in canvas
  - Set up path experiments
---
