---
name: canvas-components-agent-step
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/canvas_components/agent_step
...
triggers:
  ...
  - route users based on agent
  - personalize messages with agent
  - set output variable
---
