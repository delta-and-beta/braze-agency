---
name: canvas-components-context
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/engagement_tools/canvas/canvas_components/context
...
triggers:
  ...
  - personalizing messages with context
  - using context in Canvas journeys
  - define temporary data for users
---
