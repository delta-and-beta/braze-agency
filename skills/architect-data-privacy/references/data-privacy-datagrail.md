---
name: data-privacy-datagrail
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/data_privacy/datagrail
...
keywords:
  ...
  - deletion
triggers:
  - how to connect DataGrail to Braze
  - process data subject requests
  - set up privacy compliance
  - configure Braze API permissions
