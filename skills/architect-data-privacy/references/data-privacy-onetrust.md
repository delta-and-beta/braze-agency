---
name: data-privacy-onetrust
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/data_and_analytics/data_privacy/onetrust
...
keywords:
  ...
  - onetrust
triggers:
  - how to set up OneTrust credentials
  - create a user consent update workflow
  - create a user deletion workflow
  - add Braze as a system in OneTrust
  - integrate OneTrust with Braze
---
