---
name: extensions-surveys-iterate
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/additional_channels_and_extensions/extensions/surveys/iterate
...
keywords:
  ...
  - endpoint
triggers:
  - deliver surveys via Braze
  - connect Braze with Iterate
  - send in-app message surveys
  - collect customer feedback
  - create segments from survey responses
---
