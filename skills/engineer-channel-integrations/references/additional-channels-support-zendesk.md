---
name: additional-channels-support-zendesk
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/additional_channels_and_extensions/additional_channels/support/zendesk
...
keywords:
  ...
  - authentication
triggers:
  - how to integrate zendesk with braze
  - create support tickets in zendesk
  - set up zendesk webhook
  - configure bi-directional zendesk support
  - enable ticket automation from braze
---
