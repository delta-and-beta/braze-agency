---
name: additional-channels-instant-chat-regal
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/additional_channels_and_extensions/additional_channels/instant_chat/regal
...
keywords:
  ...
  - traits
triggers:
  - how to send calls and texts
  - create new contacts in Regal
  - trigger calls from Braze campaigns
  - sync customer data
