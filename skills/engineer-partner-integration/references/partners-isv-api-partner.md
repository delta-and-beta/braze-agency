---
name: partners-isv-api-partner
source_url: 'https://braze-inc.github.io/braze-docs/_partners/isv_partners/api_partner'
...
keywords:
  ...
  - syntax
triggers:
  - how to format user agent headers
  - partner API integration requirements
  - user agent header syntax
  - API integration guidelines
  - partner traffic tracking
---
