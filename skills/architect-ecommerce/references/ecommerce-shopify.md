...
keywords:
  ...
  - gtm
triggers:
  - how to set up Shopify with Google Tag Manager
  - integrate Braze Web SDK with third-party tools
  - configure API key for Shopify integration
  - use third-party tags on Shopify checkout
  - initialize Braze SDK timing on Shopify
---
