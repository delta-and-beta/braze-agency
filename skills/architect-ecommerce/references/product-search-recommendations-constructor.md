---
name: product-search-recommendations-constructor
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/ecommerce/product_search_recommendations/constructor
...
keywords:
  ...
  - integration
triggers:
  - how to generate product recommendations
  - set up Constructor integration
  - create abandoned cart recommendations
  - deliver personalized product suggestions
  - configure offsite discovery API
---
