---
name: product-search-recommendations-algolia
source_url: >-
  https://braze-inc.github.io/braze-docs/_partners/ecommerce/product_search_recommendations/algolia
...
keywords:
  ...
  - filtering
triggers:
  - How to integrate Algolia with Braze
  - Set up Algolia search and recommendations
  - Personalize campaigns with product recommendations
  - Query Algolia for trending products
  - Use Algolia connected content
---
