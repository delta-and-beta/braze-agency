---
name: mms-short-long-codes
source_url: >-
  https://braze-inc.github.io/braze-docs/_user_guide/message_building_by_channel/sms_mms_rcs/mms/mms_short_long_codes
...
keywords:
  ...
  - messaging
triggers:
  - enable MMS for short codes
  - send MMS with long codes
  - MMS best practices
  - set up MMS messaging
  - configure alphanumeric sender ID
---
